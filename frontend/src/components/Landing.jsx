...
function HeroVisual() { return <div className="hero-visual" aria-label="Illustration of two people connected in a virtual photobooth"><div className="orbit orbit--one"/><div className="orbit orbit--two"/><div className="video-card video-card--left"><PersonOne /><span className="video-name">Mia <b /></span></div><div className="video-card video-card--right"><PersonTwo /><span className="video-name">Noah <b /></span></div><div className="connection-line"><span>♡</span></div><div className="countdown-bubble">3</div><div className="heart-sticker">♥</div><div className="snap-label">SAY CHEESE!</div></div>; }
